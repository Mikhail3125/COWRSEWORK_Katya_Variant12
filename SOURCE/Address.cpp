...
Address::Address(int aHouseNo, const string& aStreet, const string& aCity, const string& aProvince, int aPostCode) :
	mHouseNo(aHouseNo), mStreet(aStreet), mCity(aCity), mProvince(aProvince), mPostCode(aPostCode) {
