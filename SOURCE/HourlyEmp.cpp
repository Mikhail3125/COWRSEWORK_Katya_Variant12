...
HourlyEmp::HourlyEmp(const string& aName, const string& aNIC, const Date& aDateOfBirth, const Date& aDateOfHire,
	const Address& aHomeAddress, double aTaxRate, double aBasicSalary, int aHours, double aHourlyRate) : 
	Employee(aName, aNIC, aDateOfBirth, aDateOfHire, aHomeAddress, aTaxRate, aBasicSalary), mHours(aHours), 
	mHourlyRate(aHourlyRate) {
...
void HourlyEmp::SetHourlyEmp(const string& aName, const string& aNIC, const Address& aHomeAddress, double aTaxRate, 
	double aBasicSalary, int aHours, double aHourlyRate) {
