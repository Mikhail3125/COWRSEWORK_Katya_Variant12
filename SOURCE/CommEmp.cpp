...
CommEmp::CommEmp(const string& aName, const string& aNIC, const Date& aDateOfBirth, const Date& aDateOfHire, 
	const Address& aHomeAddress, double aTaxRate, double aBasicSalary, int aSales, double aCommRate) : 
	Employee(aName, aNIC, aDateOfBirth, aDateOfHire, aHomeAddress, aTaxRate, aBasicSalary), mSales(aSales),
	mCommRate(aCommRate) {
...
void CommEmp::SetCommEmp(const string& aName, const string& aNIC, const Address& aHomeAddress, double aTaxRate, 
	double aBasicSalary, int aSales, double aCommRate) {
